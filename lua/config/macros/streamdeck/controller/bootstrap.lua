...
local DecksController = require('config.macros.streamdeck.controller.decksController')
local AppsObserver = require('config.macros.streamdeck.controller.appsObserver')
require('config.macros.streamdeck.controller.helpers')
require('config.macros.streamdeck.controller.reloader') -- side effect, comment out to disable reloader
...
-- require('config.macros.streamdeck.controller.profiles.tests.testAllObserverEvents')
...
-- local windowFilters = require('config.macros.streamdeck.controller.profiles.tests.testWindowsFilters')
